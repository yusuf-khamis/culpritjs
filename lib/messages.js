module.exports = {
  ...
  string: {
    ...
    alpha_num_dash: ':field must only contain alphanumeric (letters and numbers), underscores (_) and a dash (-) characters',
    ...
    in_array: ':field must exists in :another values',
    ...
    arg: ':arg must be a valid string format',
