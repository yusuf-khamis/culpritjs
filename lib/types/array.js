function validate (property, object, rule, args, messages, msgObj) {
  switch (rule) {
    ...
    case 'lt': {
      if (!isNaN(Number(args))) {
        throw new Error('glt requires a non-number argument')
      }
      ...
      if (typeof object[args] === 'string') {
        try {
          ...
          throw new Error('lt field argument should be an array')
        }
      }
    ...
    case 'lte': {
      ...
      if (typeof object[args] === 'string') {
        try {
          ...
          throw new Error('lte field argument should be an array')
        }
      }
